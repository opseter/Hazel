...
public:
	...
	void OnUpdate(Hazel::TimeStep ts) override
	{
		...
		for (int y = 0; y < 20; ++y) {
			for (int x = 0; x < 20; ++x)
			{
				glm::vec3 pos(x * 0.11f, y * 0.111f, 0.0f);
		...
		auto textureShader = m_ShderLibrary.Get("Texture");
...
private:
	Hazel::ShaderLibrary m_ShderLibrary;
	...
	Hazel::Ref<Hazel::Texture> m_Texture, m_ChernoLogoTexture;
